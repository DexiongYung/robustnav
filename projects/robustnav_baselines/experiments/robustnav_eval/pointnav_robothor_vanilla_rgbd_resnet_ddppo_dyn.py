"""
Experiment config to evaluate a PointNav RGB-D policy

Supports the following dynamics corruptions
...
class PointNavS2SRGBDResNetDDPPO(ExperimentConfig, ABC):
    """A PointNav Experiment Config using RGBD sensors and DDPPO"""
    ...
    @classmethod
    def tag(cls):
        return "Pointnav-RoboTHOR-Vanilla-RGBD-ResNet-DDPPO"
    ...
    def monkey_patch_env_args(
        ...
        self.ENV_ARGS["constRotate"] = constRotate
