"""
Experiment config to train a PointNav RGB policy with Action-Prediction
"""
...
from allenact.algorithms.onpolicy_sync.losses import PPO, ActionPred
from allenact.algorithms.onpolicy_sync.losses.ppo import PPOConfig
from allenact.algorithms.onpolicy_sync.losses.action_pred import ActPredConfig
...
class PointNavS2SRGBResNetDDPPO(ExperimentConfig, ABC):
    ...
    @classmethod
    def tag(cls):
        return "Pointnav-RoboTHOR-Vanilla-RGB-ResNet-Act-Pred-DDPPO"
    ...
    def training_pipeline(self, **kwargs):
        ...
        return TrainingPipeline(
            ...
            named_losses={
                ...
                "act_pred_loss": ActionPred(**ActPredConfig),
            },
            gamma=gamma,
            use_gae=use_gae,
